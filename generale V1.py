...
program=input("gravi - pendolo - moto circolare - v")													
if program == ("gravi"):																			
...
if program == ("v"):
	S0=float(input("inserire s0 (altezza posizionato il piano)"))
	h1=float(input("altezza massima piano inclinato"))
	h2=float(input("altezza minima piano inclinato"))
	velocità=math.sqrt((10*gravity*(h1-h2))/7)
	print("velocità finale al piano inclinato sono",velocità,"m/s*s approsimata senza attrito")
	distanza=math.sqrt(((20*(h1-h2)*S0)/7)-0.08)
	print("tecnicamente la distanza è : ",distanza,"m approsimo attrito con -0.08cm")
time.sleep(10)
print("By Matteo")