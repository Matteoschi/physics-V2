...
catturato = cv2.VideoCapture(r"C:\Users\alessandrini\Documents\coding\fisica\trajectory\video\2.mp4")
rapp=602
catturato.set(cv2.CAP_PROP_FRAME_WIDTH,rapp)
catturato.set(cv2.CAP_PROP_FRAME_HEIGHT,1020)
 
# Create the color Finder object
colore = ColorFinder(True)
valori_colore = {'hmin': 0, 'smin': 43, 'vmin': 156, 'hmax': 7, 'smax': 255, 'vmax': 255}
